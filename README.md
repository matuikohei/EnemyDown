...
* 実践的なプログラミングスキルの習得：<br>Javaを使って、実際に動作するソフトウェアを開発する経験を積むことで、実務に役立つスキルを習得することができると考えたため。
* データベースの操作スキルの習得：<br>ゲーム内のスコアをデータベースに保存することで、MySQLやデータベース操作の実践的なスキルを身につけることができると考えたため。
* プロジェクトの管理スキルの向上：<br>マインクラフトのプラグイン開発を通して、設計・実装・テストのサイクルを経験することで、プロジェクト管理能力を高めることができると考えたため。
