...
**ミニゲームを実装した理由**
---
このミニゲーム「EnemyDown」を実装した目的は３つあります。１つ目は、実践的なプログラミングスキルの習得のためです。Javaを使って、実際に動作するプラグインを開発する経験を積むことで、Javaの基本文法からWebアプリケーション開発で使用する知識・技術まで学ぶことができ、実務に役立つスキルを習得することができると考えました。２つ目は、データベースの知識や操作スキルの習得のためです。データベースとの連携が必要となるプラグインを開発することで、MySQLやMyBatisについて学ぶことができ、データベース操作の実践的なスキルを身につけることができると考えました。３つ目は、開発能力の習得のためです。マインクラフトのプラグイン開発を通して、設計・実装・テストのサイクルを経験することで、プログラムの要件定義や設計、実際の実装中に発生するエラーが発生した際の解決方法、テストの実施方法や重要性を学ぶことができ、開発能力を高めることができると考えました。
